...
class MidiFile:
	...
	def __init__(self,midi_file,verbose=False,debug=False):
		...
		self.virtualPianoScale = [
			'z'+'q', 'z'+'1', 'z'+'w', 'z'+'2' , 'z'+'e', 'z'+'r', 'z'+'3' , 'z'+'t', 'z'+'4', 'z'+'y', 'z'+'5', 'z'+'u', 'z'+'i', 'z'+'6', 'z'+'o', 'z'+'7', 'z'+'p', 'z'+'[', 'z'+'8', 'z'+']', 'z'+'9', 'z'+'\\', 'z'+'0', 'z'+'-',
			'x'+'q', 'x'+'1', 'x'+'w', 'x'+'2' , 'x'+'e', 'x'+'r', 'x'+'3' , 'x'+'t', 'x'+'4', 'x'+'y', 'x'+'5', 'x'+'u', 'x'+'i', 'x'+'6', 'x'+'o', 'x'+'7', 'x'+'p', 'x'+'[', 'x'+'8', 'x'+']', 'x'+'9', 'x'+'\\', 'x'+'0', 'x'+'-',
			'c'+'q', 'c'+'1', 'c'+'w', 'c'+'2' , 'c'+'e', 'c'+'r', 'c'+'3' , 'c'+'t', 'c'+'4', 'c'+'y', 'c'+'5', 'c'+'u', 'c'+'i', 'c'+'6', 'c'+'o', 'c'+'7', 'c'+'p', 'c'+'[', 'c'+'8', 'c'+']', 'c'+'9', 'c'+'\\', 'c'+'0', 'c'+'-', 'c'+'='
		]
